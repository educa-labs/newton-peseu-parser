...
pagina = requests.get('http://www.peseu.com/listas-de-seleccionados/2014/')
...
for u in ues:
    ...
    pagina_carreras = requests.get(
        'http://www.peseu.com/listas-de-seleccionados/2014/{}'.format(u))
    tree_carreras = html.fromstring(pagina_carreras.content)

    nombres_carreras = tree_carreras.xpath('//table/tr/td/text()')[::2]
    codigos_carreras = tree_carreras.xpath('//table/tr/td/a/text()')[::2]
...
with open('usuarios_peseu_2014.csv', 'w', newline='') as file:
    ...
    for universidad in universidades_con_carreras:
        ...
        for carrera in universidades_con_carreras[universidad]:
            ...
            pagina_postulacion = requests.get('http://www.peseu.com/listas-de-seleccionados/2014/{}/{}'.format(
